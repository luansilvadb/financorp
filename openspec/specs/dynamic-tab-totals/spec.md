# Specifications: Dynamic Tab Totals

Esta especificação define como os totais da aba de despesas são calculados dinamicamente com base em despesas fixas e cartão.

## Features & Scenarios

### Feature: Cálculo de Totais Consolidados
...
### Feature: Independência do Status do Pote da Casa
