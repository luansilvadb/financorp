# Specifications: Unified Avatar (DiviAvatar)

Esta especificação define o componente de avatar unificado utilizado em todo o sistema para representar os moradores.
